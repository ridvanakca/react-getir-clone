        ...
        <div className='w-full md:w-[400px] md:rounded-lg bg-gray-50 p-6'>
          ...
          <div className='grid gap-y-3'>
            ...
            <label className='flex-1 relative block cursor-pointer group'>
              <input className='h-14 px-4 border-2 border-gray-200 rounded w-full transition-colors group-hover:border-primary-brand-color outline-none peer text-sm pt-2' required/>
              <span className='absolute top-0 left-0 h-full px-4 flex items-center text-sm text-gray-700 transition-all  peer-valid:h-7 peer-valid:text-primary-brand-color peer-valid:text-xs'>Telefon Numarası</span>
            </label>
            </div>
            ...
            <button className='bg-blue-700 bg-opacity-10 transition-colors hover:bg-blue-700  hover:text-white h-12 flex items-center rounded-md w-full text-sm font-semibold text-blue-700 text-opacity-80 px-4'>
              <FaFacebook size={24} />
